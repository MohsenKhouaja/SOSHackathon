                    ...
                    <CardContent>
                        <div className="grid gap-4 sm:grid-cols-3">
                            ...
                            <div className="flex flex-col items-center justify-center p-4 border rounded-md bg-destructive/10">
                                <span className="text-3xl font-bold text-destructive">{incidentsByUrgency?.CRITICAL || 0}</span>
                            ...
                            <div className="flex flex-col items-center justify-center p-4 border rounded-md bg-orange-100 dark:bg-orange-900/20">
                                <span className="text-3xl font-bold text-orange-600">{incidentsByUrgency?.HIGH || 0}</span>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="space-y-2">
                                <StatusRow label="Reported" count={incidentsByStatus?.REPORTED} icon={AlertTriangle} color="text-yellow-500" />
                                <StatusRow label="Evaluation" count={incidentsByStatus?.EVALUATION} icon={Activity} color="text-blue-500" />
                                <StatusRow label="Action Plan" count={incidentsByStatus?.ACTION_PLAN} icon={Clock} color="text-purple-500" />
                                <StatusRow label="Follow Up" count={incidentsByStatus?.FOLLOW_UP} icon={Clock} color="text-indigo-500" />
                                <StatusRow label="Formal Decision" count={incidentsByStatus?.FORMAL_DECISION} icon={CheckCircle} color="text-green-500" />
                                <StatusRow label="Closed" count={incidentsByStatus?.CLOSED} icon={CheckCircle} color="text-gray-500" />
                            </div>
                        </div>
                    </CardContent>
                </Card>
