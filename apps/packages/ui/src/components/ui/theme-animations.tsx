/** biome-ignore-all lint/style/useBlockStatements: good */
/** biome-ignore-all lint/suspicious/noDoubleEquals: good */
/** biome-ignore-all lint/complexity/noExcessiveCognitiveComplexity: good */
/** biome-ignore-all lint/nursery/noUnnecessaryConditions: good */
/** biome-ignore-all lint/nursery/noShadow: good */
/** biome-ignore-all lint/nursery/useExhaustiveSwitchCases: good */
/** biome-ignore-all lint/style/useDefaultSwitchClause: good */
...
export const useThemeToggle = ({
  ...
  const { theme, setTheme } = useThemeReact();
