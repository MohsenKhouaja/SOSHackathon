/** biome-ignore-all lint/correctness/useExhaustiveDependencies: yes */
/** biome-ignore-all lint/suspicious/noShadowRestrictedNames: yes */
"use client";
...
const positionClasses = {
  ...
  "top-center": "top-2 right-1/2 -translate-x-1/2",
  "bottom-center": "bottom-10 right-1/2 -translate-x-1/2",
  ...
  return (
    <ControlButton label="Reset bearing to north" onClick={onClick}>
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <title className="sr-only">Reset bearing to north</title>
