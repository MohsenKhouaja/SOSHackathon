  ...
  return (
    <Comp
      className={cn(
        ...
        "data-[active=true]:bg-sidebar-accent-foreground/5 data-[active=true]:text-sidebar-accent-foreground",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
